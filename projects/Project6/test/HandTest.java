...
public class HandTest extends TestCase {
    ...
    public void testHasFourOfAKind() {
        Card[] cards = {new Card(10,'c'), new Card(11,'d'), new Card(11,'c'), new Card(11,'c'), 
                        new Card(11,'c')};
        Hand fourOfAKind = new Hand(cards);
        assertTrue("Four of a kind hand", fourOfAKind.hasFourOfAKind());
        assertFalse("Not four of a kind hand", hand.hasFourOfAKind());
    }
     
	@Test 
    public void testHasThreeOfAKind() {
        Card[] cards = {new Card(10,'c'), new Card(11,'d'), new Card(12,'d'), new Card(12,'c'), 
                        new Card(12,'c')};
        Hand threeOfAKind = new Hand(cards);
        assertTrue("Three of a kind hand", threeOfAKind.hasThreeOfAKind());
        assertFalse("Not three of a kind hand", hand.hasThreeOfAKind());
    }
    
    @Test 
    public void testHasTwoPairs() {
        Card[] cards = {new Card(10,'c'), new Card(10,'d'), new Card(11,'d'), new Card(11,'c'), 
                        new Card(12,'c')};
        Hand twoPairs = new Hand(cards);
        assertTrue("Two pairs hand", twoPairs.hasTwoPairs());
        assertFalse("Not two pairs hand", hand.hasTwoPairs());
    }
    
    @Test 
    public void testHasOnePair() {
        Card[] cards = {new Card(10,'c'), new Card(11,'d'), new Card(11,'s'), new Card(12,'c'), 
                        new Card(13,'c')};
        Hand onePair = new Hand(cards);
        assertTrue("One pair hand", onePair.hasOnePair());
        assertFalse("Not one pair hand", hand.hasOnePair());
    }
    
    @Test 
    public void testIsFullHouse() {
        Card[] cards = {new Card(10,'c'), new Card(10,'d'), new Card(11,'s'), new Card(11,'c'), 
                        new Card(11,'c')};
        Hand fullHouse = new Hand(cards);
        assertTrue("Full house hand", fullHouse.isFullHouse());
